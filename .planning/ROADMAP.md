...
- [x] 03-07-PLAN.md — Concurrency caps and the pause/kill control plane

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 03-08-PLAN.md — The `adl` verb set and the GC schedule
...
- [x] 04-05-PLAN.md — The NDJSON transcript store: deterministic path, byte-offset append and read
